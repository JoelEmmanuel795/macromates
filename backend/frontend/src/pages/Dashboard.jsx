...
export default function Dashboard() {
    ...
    return (
        <div className="flex flex-col mx-auto max-w-[480px] gap-6 p-4 md:p-6 mb-4">
            {/* Welcome Section */}
            <div
                className="w-full max-w-md md:max-w-lg bg-base-200 rounded-lg p-4 md:p-6 shadow-[4px_4px_12px_0_rgba(0,0,0,0.28)]">
            ...
            {totalTargetMacros && !loadingMacros && (
                <div
                    className="w-full max-w-md md:max-w-lg flex flex-col items-center rounded-lg p-4 shadow-[4px_4px_12px_0_rgba(0,0,0,0.15)]">
