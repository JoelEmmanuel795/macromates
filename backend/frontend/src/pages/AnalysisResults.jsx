    ...
    return (
        <div className="min-h-screen bg-base-100 flex flex-col">
                        ...
                        <>
                            ...
                            <div className="card bg-base-200 p-6 mb-4 shadow-[4px_4px_12px_0_rgba(0,0,0,0.28)]">
                                ...
                                <div className="flex gap-4 mb-4">
                                    ...
                                    {analysis.image_url ? (
                                        ...
                                        <div className="flex-shrink-0">
                                            <div
                                                className="w-24 h-32 rounded-lg overflow-hidden bg-base-200 flex items-center justify-center">
                                                <svg
                                                    width="32"
                                                    height="32"
                                                    viewBox="0 0 24 24"
                                    ...
                                    <div className="space-y-3">
                                        {(
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        className="flex items-center text-primary group-hover:text-base-content/90">
                            <span className="text-lg font-medium">
                              {foodItem.name}
                            </span>
                                                        <span
                                                            className="ml-2 text-sm text-primary group-hover:text-base-content/90">
                            ...
                            {insightSections.alignment && (
                                <div className="card bg-base-200 p-6 mb-4 shadow-[4px_4px_12px_0_rgba(0,0,0,0.28)]">
                                    <div className="flex items-center mb-3">
                                        <div
                                            className="w-8 h-8 bg-accent rounded-full flex items-center justify-center mr-3">
                                            <svg
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50">
                ...
                <div
                    className="bg-base-300 bg-opacity-95 backdrop-blur-md rounded-t-3xl shadow-2xl border-t-2 border-green-950 px-8 py-4">
