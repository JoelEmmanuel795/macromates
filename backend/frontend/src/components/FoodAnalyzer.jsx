        ...
        <div className="relative w-full h-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black flex items-center justify-center z-10">
                    <div className="text-white text-center p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <label
                                className="block w-full px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-500 transition-colors cursor-pointer">
            ...
            {!capturedImage && (
                <div className="absolute inset-0 z-10 pointer-events-none">
                    ...
                    <div
                        className="absolute top-0 left-0 right-0 h-24 bg-black bg-opacity-10 flex items-center justify-center">
                        {!cameraError && (
                    ...
                    <div
                        className="absolute top-24 right-8 w-6 h-6 border-t-2 border-r-2 border-white opacity-60"></div>
                    <div
                        className="absolute bottom-28 left-8 w-6 h-6 border-b-2 border-l-2 border-white opacity-60"></div>
                    <div
                        className="absolute bottom-28 right-8 w-6 h-6 border-b-2 border-r-2 border-white opacity-60"></div>
                </div>
            )}
            ...
            {capturedImage && (isLoading || loading) && (
                <div className="absolute inset-0 z-10 pointer-events-none">
                    <div
                        className="absolute top-0 left-0 right-0 h-24 bg-black bg-opacity-30 flex items-center justify-center">
                        <div className="bg-black bg-opacity-60 px-4 py-2 rounded-lg">
                            <p className="text-white text-sm font-medium text-center">
                                Analyzing your food...
                            </p>
            ...
            <div
                className="absolute bottom-8 left-0 right-0 flex items-center justify-between px-8 pointer-events-auto z-[60]">
                {/* Back button */}
                <button
                    onClick={onBack}
