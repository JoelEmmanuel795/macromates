...
export default function CongratsSection() {
    ...
    return (
        <div className="w-full max-w-xs mx-auto">
            <div
                className="bg-base-200/75 border border-base-300 rounded-box p-6 max-w-xs w-full space-y-6 text-center">
                ...
                <div className="space-y-4">
                    <Link to="/verification" className="btn btn-primary w-full">
                        Continue
                    </Link>
